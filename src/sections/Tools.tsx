...
export const Tools = () => {
  return (
    <div id="tools" className="py-20 bg-white px-5 space-y-16">
      {/* Visualize Section */}
      <div id="visualize" className="flex flex-col md:flex-row items-center">
        <div className="flex-1 mb-6 md:mb-0 md:mr-6">
          <h3 className="text-3xl font-bold text-gray-800 mb-4">Visualize</h3>
      ...
      <div id="manage" className="flex flex-col md:flex-row items-center">
        <div className="flex-1 mb-6 md:mb-0 md:mr-6">
          <h3 className="text-3xl font-bold text-gray-800 mb-4">Manage</h3>
          <p className="text-gray-600 mb-4">
      ...
      <div id="reports" className="flex flex-col md:flex-row items-center">
        <div className="flex-1 mb-6 md:mb-0 md:mr-6">
          <h3 className="text-3xl font-bold text-gray-800 mb-4">Reports</h3>
          <p className="text-gray-600 mb-4">
      ...
      <div id="invoices" className="flex flex-col md:flex-row items-center">
        <div className="flex-1 mb-6 md:mb-0 md:mr-6">
          <h3 className="text-3xl font-bold text-gray-800 mb-4">Invoices</h3>
          <p className="text-gray-600 mb-4">
      ...
      <div id="logistics" className="flex flex-col md:flex-row items-center">
        <div className="flex-1 mb-6 md:mb-0 md:mr-6">
          <h3 className="text-3xl font-bold text-gray-800 mb-4">Logistics</h3>
          <p className="text-gray-600 mb-4">
        ...
        <div className="flex-1">
          <Image src={Logistics} alt="Logistics Management" className="rounded-lg shadow-lg" />
        </div>
      </div>
    </div>
  );
